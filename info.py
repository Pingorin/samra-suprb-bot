...
PREMIUM_IDS = [int(premiums) if id_pattern.search(premiums) else premiums for premiums in environ.get('PREMIUM_IDS', '').split()]
...
LANGUAGES = ["hindi", "english", "malayalam", "tamil", "telugu", "kannada"]
